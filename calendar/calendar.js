var CalendarHeader = React.createClass({
    ...
    render:function(){
        return(
            ...
            <div className="time">{this.state.month}月{this.state.year}年</div>
<div className="triangle-left"  onClick={this.handleLeftClick}> <div className="tr-left-out"><div className="tr-left-in"></div ></div></div>
<div className="triangle-right" onClick={this.handleRightClick}><div className="tr-right-out"> <div className="tr-right-in"> </div ></div> </div>
</div>
)
}
});
var CalendarBody = React.createClass({
    ...
    render:function(){
        ...
        var node2 = arry2.map(function(item){
                return (curday == item)?<li style={{"color": "#1CC263","font-weight":"bold"}}>{item}</li>: <li>{item}</li>
    })
return(
    <div>
